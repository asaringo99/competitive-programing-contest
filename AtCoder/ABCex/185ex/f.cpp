...
template<typename T> struct SplayTree{
    ...
    private:
        ...
        void update(){
            ...
            if(this->lef){
                ...
                this->xorval = this->xorval ^ this->lef->xorval;
            ...
            if(this->rig){
                ...
                this->xorval = this->xorval ^ this->rig->xorval;
        ...
        pair<SplayTree*,T> get_xor(int l, int r, SplayTree *root){
            auto[lef_root, mid_root, rig_root] = split3(l,r,root);
            T res = mid_root->xorval;
            return {merge(merge(lef_root,mid_root),rig_root), res};
        }
    ...
    public:
        ...
        T get_xor(int l, int r) { auto[root, res] = get_xor(l,r,ROOT); ROOT = root; return res; }
